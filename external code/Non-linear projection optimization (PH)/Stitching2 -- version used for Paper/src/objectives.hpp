...
public:
    ...
    Eigen::VectorXd gaussianCurvatureNormalization;
    Eigen::VectorXd currentDevelopabilityObjective;
    Eigen::VectorXd currentProximityObjective;
    Eigen::VectorXd currentSmoothnessObjective;
    Eigen::VectorXd currentSeamProximityObjective;
    Eigen::VectorXd currentSeamSmoothnessObjective;
    Eigen::VectorXd currentBoundaryProximityObjective;
    ...
    void updateGaussianCurvatureNormalization(const Eigen::MatrixXd& V);
};
